...
namespace MVCBlog.Migrations
{
    ...
    [Migration("20210413081916_initialV1-2")]
            ...
            modelBuilder.Entity("MVCBlog.Models.DataAccess.Entities.Concrete.Article", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 4, 13, 11, 19, 15, 944, DateTimeKind.Local).AddTicks(4131));
            ...
            modelBuilder.Entity("MVCBlog.Models.DataAccess.Entities.Concrete.Member", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 13, 11, 19, 15, 932, DateTimeKind.Local).AddTicks(8538));
