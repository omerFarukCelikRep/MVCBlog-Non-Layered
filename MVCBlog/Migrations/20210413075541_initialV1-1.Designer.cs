...
namespace MVCBlog.Migrations
{
    ...
    [Migration("20210413075541_initialV1-1")]
            ...
            modelBuilder.Entity("MVCBlog.Models.DataAccess.Entities.Concrete.Article", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 4, 13, 10, 55, 41, 171, DateTimeKind.Local).AddTicks(2861));
            ...
            modelBuilder.Entity("MVCBlog.Models.DataAccess.Entities.Concrete.Member", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 13, 10, 55, 41, 162, DateTimeKind.Local).AddTicks(3418));
